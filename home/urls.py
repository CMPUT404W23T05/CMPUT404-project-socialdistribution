...
app_name = 'home'
urlpatterns = [
        path('users/me/', views.CustomUserViewSet.as_view({'options': 'options'}), name='user-options'),
        ...
        path('authors/<uuid:author_id>/followers/<path:follower_id>/', social_views.FollowersDetails.as_view()),
        ...
        path('authors/<uuid:author_id>/inbox', views.RedirectToInbox.as_view()),
