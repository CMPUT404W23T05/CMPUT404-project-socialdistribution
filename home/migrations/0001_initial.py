# Generated by Django 4.1.6 on 2023-03-19 17:40
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('author', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='posts', to='home.author', to_field='url_id')),
            ],
            options={
                'ordering': ('-pub_date',),
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pub_date', models.DateTimeField(auto_now_add=True, null=True)),
                ('author', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='comments', to='home.author', to_field='url_id')),
            ],
            options={
                'ordering': ('-pub_date',),
            },
