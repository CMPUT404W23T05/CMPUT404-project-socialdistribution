...
class InboxTesting(TestCase):
    def setUp(self):
        ...
        # author 1 (our "local" author) leave a comment on the remote author's post
        '''
    ...
    def receiving_comment_from_remote_author(self):
        example_comment = {
            "type": "comment",
    ...
    def receiving_like_from_remote_author(self):
        example_like = {
            "type": "Like",
